<template>
  <button class="p-1 border-2 border-transparent text-gray-500 rounded-full hover:text-white focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out">
    <svg
